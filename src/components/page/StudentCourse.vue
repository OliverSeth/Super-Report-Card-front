    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="courseTable" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="SUBJECT_NAME" label="科目" sortable width="350">
                </el-table-column>
                <el-table-column prop="CLASS_NAME" label="班级" width="400">
                </el-table-column>
...
<script>
    export default {
        ...
        mounted(){
            let api=this.$api.userApi.getCourseByStudent;
        ...
        methods: {
            // addExam(row){
            //     localStorage.setItem('course',this.courseTable);
            //     // localStorage.setItem('id',row.COURSE_ID);
            //     this.$router.push('/form?course_id='+row.COURSE_ID);
            // },
            // 分页导航
            ...
            exam(row) {
                this.$router.push('/course-grade?course_id='+row.COURSE_ID);
            },
            delAll() {
